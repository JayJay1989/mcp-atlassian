...
| `JIRA_SMART_CHECKLIST_FIELD_ID` | Jira custom field ID for the Smart Checklist `Checklists` field (default: `customfield_18600`). The readable value lives in field ID + 1 (e.g. `customfield_18601`); updates go through the Railsware REST API | `customfield_18600` |
